                ...
                <div class="col-sm-6">
                    <div class="card1">
                        ...
                        <div class="card-inner">
                            <div class="header01">
                                <h2>Assureur</h2>
                                <a href="CreerAssureur.jsp" class="stretched-link"></a>
                            </div>
                            <div class="content">
                                <p>Content area</p>
                            </div>
                    ...
                    <div class="card1">
                        ...
                        <div class="card-inner">
                            <div class="header01">
                                <h2>Client</h2>
                                <a href="CreerClientUnique.jsp" class="stretched-link"></a>
                            </div>
                            <div class="content">
                                <p>Content area</p>
                            </div>
                    ...
                    <div class="card1">
                        ...
                        <div class="card-inner">
                            <div class="header01">
                                <h2>Courtier</h2>
                                <a href="CreerCourtier.jsp" class="stretched-link"></a>
                            </div>
                            <div class="content">
                                <p>Content area</p>
                            </div>
                ...
                <div class="col-sm-6">
                    <div class="card1">
                        ...
                        <div class="card-inner">
                            <div class="header01">
                                <h2>Entreprise</h2>
                               <a href="CreerEntreprise.jsp" class="stretched-link"></a> 
