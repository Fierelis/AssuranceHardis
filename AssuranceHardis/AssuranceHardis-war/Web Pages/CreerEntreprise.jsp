                            ...
                            <form action="#" class="signin-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="form-group mb-3">
                                                <label class="label" for="PrenomCourtier">Prénom</label>
                                                <input type="text" class="form-control" name ="PrenomCourtier" placeholder="Prénom" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name ="AdresseCourtier" placeholder="N° de rue, compléments, tg" required>
                                                    </div>
