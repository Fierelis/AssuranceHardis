		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
		            ...
		            <div class="form-group mb-3">
		            	<label class="label" for="MdpAssur">Mot de passe</label>
		              <input type="password" class="form-control" name ="MdpAssur" placeholder="Mot de passe" required>
		            </div>

                    <div class="form-group">
                        <div class="form-group mb-3">
                            <label class="label" for="EmailAssur">Adresse mail</label>
                          <input type="text" class="form-control" name ="EmailAssur" placeholder="Adresse mail" required>
                        </div>

		            <div class="form-group">
		            <div class="form-group mb-3">
		            	<label class="label" for="RaisonSocialeAssur">Raison sociale</label>
		              <input type="text" class="form-control" name ="RaisonSocialeAssur" placeholder="Raison sociale" required>
		            </div>

		            <div class="form-group">
		            <div class="form-group mb-3">
		            	<label class="label" for="SiegeSocialAssur">Siège social</label>
		              <input type="text" class="form-control" name ="SiegeSocialAssur" placeholder="Siège social" required>
		            </div>

                    <div class="form-group">
                        <div class="form-group mb-3">
                            <label class="label" for="DateCreationAssurance">Date de création</label>
                          <input type="date" class="form-control" name ="DateCreationAssur" placeholder="Date de création" required>
                        </div>

		            <div class="form-group">
		            <div class="form-group mb-3">
		            	<label class="label" for="numSiren">N° Siren</label>
		              <input type="number" class="form-control" name ="numSiren" placeholder="SIREN (8 CHIFFRES)" required>
		            </div>
