                            ...
                            <div class="wrap d-md-flex">
                                <div class="text-wrapp p-4 p-lg-5">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="password" class="form-control" name ="MdpClient" placeholder="Mot de passe" id ="monmdp" required>
                                ...
                                <div class="login-wrap p-4 p-lg-5">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name ="PrenomClient" placeholder="Prénom" required>
                                        </div>
