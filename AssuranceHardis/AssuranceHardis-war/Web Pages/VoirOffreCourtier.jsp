                        ...
                        <table class="table livres">
                            ...
                            <tbody>
                                ...
                                <form style="display: flex ; justify-content: flex-end">
                                    <button type="submit" name="OffreVia" class="form-control btn2 btn2-primary submit px-3" style="width:20%" value="<%=offer.getId()%>">Créer une Offre </button> 
                                    <input type="hidden" name="action" value="CreerOffreViaCourtier">
                                </form>
                </div>
            </div>
        </div>
